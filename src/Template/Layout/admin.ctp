...
<head>
    ...
    //echo $this->Html->css( 'https://cdn.jsdelivr.net/npm/bootstrap@3.4.1/dist/css/bootstrap-theme.min.css' );
    if (get_option('language_direction') == 'rtl') {
        ...
        //echo $this->Html->css( 'https://cdn.jsdelivr.net/gh/morteza/bootstrap-rtl@3.4.0/dist/css/bootstrap-flipped.min.css' );
    }
...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <?php
                        $gravatar_md5 = md5(strtolower($user['email']));
                        ?>
                        <!-- Menu Toggle Button -->
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <!-- The user image in the navbar-->
                            <img src="<?= "https://www.gravatar.com/avatar/" . $gravatar_md5 . "?s=160" ?>"
                                 class="user-image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <?php if (in_array($user['role'], [1]) && require_database_upgrade()) : ?>
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo $this->Url->build(['controller' => 'Bundles', 'action' => 'index']); ?>"><i
                            class="fa fa-tags"></i> <span><?= __('Manage Bundles') ?></span></a></li>
