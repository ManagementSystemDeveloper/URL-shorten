...
<div class="box box-primary">
    <div class="box-body">
        ...
        <span class="help-block"><?= __(
            'You can find the setup instructions <a href="{0}" target="_blank">here</a>.',
            'https://mightyscripts.freshdesk.com/support/solutions/articles/5000721764-social-login-with-facebook'
        ) ?></span>
        ...
        <span class="help-block"><?= __(
            'You can find the setup instructions <a href="{0}" target="_blank">here</a>.',
            'https://mightyscripts.freshdesk.com/support/solutions/articles/5000721765-social-login-with-twitter'
        ) ?></span>
        ...
        <span class="help-block"><?= __(
            'You can find the setup instructions <a href="{0}" target="_blank">here</a>.',
            'https://mightyscripts.freshdesk.com/support/solutions/articles/5000721767-social-login-with-google'
        ) ?></span>
