...
<div class="box box-primary">
    <div class="box-body">
        <?= $this->Form->create($options, [
            'id' => 'form-settings',
            'onSubmit' => "save_settings.disabled=true; save_settings.innerHTML='" .
                __('Saving ...') . "'; return true;",
        ]); ?>
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738312-paypal-setup"
            ) ?></span>
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738313-stripe-setup"
            ) ?></span>
        <div class="row">
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738314-payza-setup"
            ) ?></span>
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738315-skrill-setup"
            ) ?></span>
        ...
        <div class="conditional" data-cond-option="Options[<?= $settings['bitcoin_processor']['id'] ?>][value]"
            ...
            <span class="help-block"><?= __(
                    'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                    "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738316-coinpayments-setup"
                ) ?></span>
        ...
        <div class="conditional" data-cond-option="Options[<?= $settings['bitcoin_processor']['id'] ?>][value]"
            ...
            <span class="help-block"><?= __(
                    'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                    "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738317-coinbase-settings"
                ) ?></span>
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738318-webmoney-settings"
            ) ?></span>
        ...
        <span class="help-block"><?= __(
                'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738319-perfect-money-settings"
            ) ?></span>
        ...
        <span class="help-block">
                <?= __(
                    'For setup instructions click <a href="{0}" target="_blank">here</a>.',
                    "https://mightyscripts.freshdesk.com/support/solutions/articles/5000738320-payeer-settings"
                ) ?>
            </span>
