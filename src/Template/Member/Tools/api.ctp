...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __(
                'For developers {0} prepared <b>API</b> which returns responses in <b>JSON</b> or <b>TEXT</b> formats. ',
        ...
        unset($allowed_ads[get_option('member_default_redirect', 1)]);
        ?>
        ...
        <div class="well">
            ...
            $alias = urlencode('CustomAlias');<br>
            $api_url = "<?= $this->Url->build('/', true); ?>api?api=<b>{$api_token}</b>&url=<b>{$long_url}</b>&alias=<b>{$alias}</b>";<br>
        ...
        <div class="well">
            ...
            $api_token = '<?= $logged_user->api_token ?>';<br>
            $alias = urlencode('CustomAlias');<br>
            $api_url = "<?= $this->Url->build('/', true); ?>api?api=<b>{$api_token}</b>&url=<b>{$long_url}</b>&alias=<b>{$alias}</b>&format=<b>text</b>";<br>
