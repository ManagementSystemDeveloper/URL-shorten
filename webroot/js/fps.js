...
document.addEventListener('DOMContentLoaded', function (event) {
    if (typeof app_url === 'undefined') {
        if (typeof mighty_url !== 'undefined') {
            app_url = mighty_url;
        } else {
            return;
        }
    ...
    if (typeof app_api_token === 'undefined') {
        if (typeof mighty_api_token !== 'undefined') {
            app_api_token = mighty_api_token;
        } else {
            return;
        }
    }

    if (typeof app_redirect === 'undefined') {
        if (typeof mighty_type !== 'undefined') {
            app_redirect = mighty_type;
        } else {
            app_redirect = 1;
        }
    }
    ...
    if (typeof app_domains === 'undefined') {
        if (typeof mighty_domains !== 'undefined') {
            app_domains = mighty_domains;
        }
    }
    ...
    if (typeof app_exclude_domains === 'undefined') {
        if (typeof mighty_exclude_domains !== 'undefined') {
            app_exclude_domains = mighty_exclude_domains;
        }
    }
    if (typeof app_exclude_domains !== 'undefined') {
        for (var i = 0; i < anchors.length; i++) {
